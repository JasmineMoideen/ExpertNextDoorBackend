...
<div class="customer-registration">
    ...
    if (isset($_POST['register_customer'])) {
        ...
        if (!is_wp_error($user_id)) {
            echo '<p style="color:green;">✅ Registration successful! You can now <a href="' . wp_login_url('https://expert-next-door.vercel.app/') . '">login</a>.</p>';
        } else {
    ...
    <form method="post">
        ...
        <input type="submit" class = "customer-form customer-form-btn" name="register_customer" value="Register">
    </form>
